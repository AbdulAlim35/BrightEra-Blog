  ...
  return (
    <section className="min-h-screen  p-6">
      <div className="max-w-3xl mx-auto mt-10 bg-white p-6 rounded-xl shadow-md border border-gray-100">
        <h2 className="text-2xl font-bold mb-6 text-gray-800">Admin Info Form</h2>
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            className=" bg-blue-600 text-white font-medium px-5 py-2 rounded-md hover:bg-blue-700 transition cursor-pointer"
          >
            Save
          </button>
        </form>
